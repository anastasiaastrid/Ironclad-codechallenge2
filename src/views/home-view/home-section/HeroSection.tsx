      ...
      {data.length > 0 &&
        data.map((datamap) => (
          ...
          <div key={datamap.sys.id} className="relative">
            <Image
              className="w-[404.1px] h-[437.4px] object-cover lg:object-cover lg:h-full lg:w-full md:object-cover md:h-full md:w-full sm:object-cover sm:h-full sm:w-full"
              alt="Image"
              // @ts-ignore
